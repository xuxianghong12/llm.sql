...
def main() -> None:
    ...
    with warnings.catch_warnings():
        ...
        ep_prefill = export_prefill_graph(model, example_seq_len=args.example_seq_len)
        ep_decode = export_decode_graph(model, example_cache_seq_len=args.example_seq_len)
