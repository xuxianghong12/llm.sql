...
/* N-D layout and indexing wrappers live in llm_ops_x86_nd_layout.c. */
/* N-D algebra and broadcast wrappers live in llm_ops_x86_nd_algebra.c. */
/* Shared N-D helpers live in llm_ops_x86_common.c. */
/* N-D softmax, aggregate, and debug-string wrappers live in llm_ops_x86_nd_stats.c. */

/* N-D divide and comparison wrappers live in llm_ops_x86_nd_algebra.c. */

/* N-D unary and pointwise transforms live in llm_ops_x86_nd_pointwise.c. */

/* N-D logic, remainder, and inspection wrappers live in llm_ops_x86_nd_utility.c. */

/* N-D reduction and value-selection wrappers live in llm_ops_x86_nd_reduce.c. */

/* N-D normalization and model wrappers live in llm_ops_x86_nd_model.c. */

/* N-D masking, factory, and utility wrappers live in llm_ops_x86_nd_utility.c. */

/* ===========================================================================
 * Section 13b: Additional N-D ops (cumsum, gather, index_select, repeat, etc.)
 * =========================================================================*/

/* N-D cumulative scan and indexed selection wrappers live in llm_ops_x86_nd_sequence.c. */

/* N-D scatter, repeat, and reorder wrappers live in llm_ops_x86_nd_sequence.c. */

/* N-D indexed update and structural reorder wrappers live in llm_ops_x86_nd_sequence.c. */

/* N-D norms, masks, and attention wrappers live in llm_ops_x86_nd_model.c. */

/* INT8 quantization and parameter-backed inference wrappers live in llm_ops_x86_int8.c. */
