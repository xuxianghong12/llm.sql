/*
 * llm_ops_x86_internal.h - Shared internal interfaces for split x86 ops
 *
 * This header centralizes the private macros, helper declarations, and
 * cross-file SQL wrapper prototypes used by the x86 operator implementation.
 ...
 */
#ifndef LLM_OPS_X86_INTERNAL_H
#define LLM_OPS_X86_INTERNAL_H
