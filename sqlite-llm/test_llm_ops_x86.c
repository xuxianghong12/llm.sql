...
static void test_nd_and_int8_smoke_x86(sqlite3 *db) {
    static const char *smoke_sqls[][2] = {
        ...
        {"llm_shape_x86", "SELECT llm_shape(llm_view_nd(llm_vec(6, 1.0), 2, 3), 1)"},
        {"llm_view_nd_x86", "SELECT llm_view_nd(llm_vec(6, 1.0), 2, 3)"},
        {"llm_view_t12_nd_x86", "SELECT llm_view_t12_nd(llm_vec(8, 1.0), 1, 2, 4)"},
        {"llm_permute_nd_x86", "SELECT llm_permute_nd(llm_view_nd(llm_vec(6, 1.0), 2, 3), 1, 0)"},
        {"llm_transpose_nd_x86", "SELECT llm_transpose_nd(llm_view_nd(llm_vec(6, 1.0), 2, 3), 0, 1)"},
        {"llm_unsqueeze_nd_x86", "SELECT llm_unsqueeze_nd(llm_vec(4, 1.0), 0)"},
        {"llm_squeeze_nd_x86", "SELECT llm_squeeze_nd(llm_unsqueeze_nd(llm_vec(4, 1.0), 0), 0)"},
        {"llm_cat_nd_x86", "SELECT llm_cat_nd(llm_view_nd(llm_vec(4, 1.0), 2, 2), llm_view_nd(llm_vec(4, 2.0), 2, 2), 1)"},
        {"llm_slice_nd_x86", "SELECT llm_slice_nd(llm_view_nd(llm_vec(6, 1.0), 2, 3), 1, 0, 2)"},
        {"llm_select_nd_x86", "SELECT llm_select_nd(llm_view_nd(llm_vec(6, 1.0), 2, 3), 1, 1)"},
        {"llm_expand_nd_x86", "SELECT llm_expand_nd(llm_view_nd(llm_vec(3, 1.0), 1, 3), 2, 3)"},
        {"llm_bmm_x86", "SELECT llm_bmm(llm_view_nd(llm_vec(8, 1.0), 1, 2, 4), llm_view_nd(llm_vec(12, 1.0), 1, 4, 3))"},
        {"llm_linear_nd_x86", "SELECT llm_linear_nd(llm_view_nd(llm_vec(4, 1.0), 1, 4), llm_view_nd(llm_vec(8, 1.0), 2, 4))"},
        {"llm_add_nd_x86", "SELECT llm_add_nd(llm_vec(4, 1.0), llm_vec(4, 2.0))"},
        {"llm_mul_nd_x86", "SELECT llm_mul_nd(llm_vec(4, 1.0), llm_vec(4, 2.0))"},
        {"llm_sub_nd_x86", "SELECT llm_sub_nd(llm_vec(4, 1.0), llm_vec(4, 2.0))"},
        ...
        {"llm_softmax_nd_x86", "SELECT llm_softmax_nd(llm_view_nd(llm_vec(6, 1.0), 2, 3), 1)"},
        {"llm_mean_nd_x86", "SELECT llm_mean_nd(llm_view_nd(llm_vec(6, 1.0), 2, 3), 1, 1)"},
        {"llm_sum_nd_x86", "SELECT llm_sum_nd(llm_view_nd(llm_vec(6, 1.0), 2, 3), 1, 0)"},
        {"llm_str_nd_x86", "SELECT llm_str_nd(llm_view_nd(llm_vec(6, 1.0), 2, 3))"},
        {"llm_div_nd_x86", "SELECT llm_div_nd(llm_vec(4, 2.0), llm_vec(4, 1.0))"},
        ...
        {"llm_silu_mul_nd_x86", "SELECT llm_silu_mul_nd(llm_vec(4, 1.0), llm_vec(4, 2.0))"},
        {"llm_rope_nd_x86", "SELECT llm_rope_nd(llm_view_nd(llm_vec(4, 1.0), 1, 1, 1, 4), llm_view_nd(llm_vec(4, 1.0), 1, 1, 1, 4), llm_view_nd(llm_vec(4, 0.0), 1, 1, 1, 4))"},
        ...
        {"llm_embedding_nd_x86", "SELECT llm_embedding_nd(llm_view_nd(llm_vec(12, 1.0), 3, 4), llm_view_nd(llm_vec(2, 1.0), 2))"},
        {"llm_rmsnorm_nd_x86", "SELECT llm_rmsnorm_nd(llm_view_nd(llm_vec(4, 1.0), 1, 4), llm_vec(4, 1.0), 1e-5)"},
        {"llm_triu_nd_x86", "SELECT llm_triu_nd(llm_view_nd(llm_vec(9, 1.0), 3, 3), 0)"},
        {"llm_where_nd_x86", "SELECT llm_where_nd(llm_vec(4, 1.0), llm_vec(4, 2.0), llm_vec(4, 3.0))"},
        {"llm_masked_fill_nd_x86", "SELECT llm_masked_fill_nd(llm_vec(4, 2.0), llm_vec(4, 1.0), -1.0)"},
        {"llm_arange_nd_x86", "SELECT llm_arange_nd(8)"},
        {"llm_full_nd_x86", "SELECT llm_full_nd(1.5, 2, 3)"},
        {"llm_argmax_nd_x86", "SELECT llm_argmax_nd(llm_view_nd(llm_vec(6, 1.0), 2, 3), 1)"},
        ...
        {"llm_tril_nd_x86", "SELECT llm_tril_nd(llm_view_nd(llm_vec(9, 1.0), 3, 3), 0)"},
        {"llm_logical_not_nd_x86", "SELECT llm_logical_not_nd(llm_vec(4, 0.0))"},
        {"llm_logical_and_nd_x86", "SELECT llm_logical_and_nd(llm_vec(4, 1.0), llm_vec(4, 1.0))"},
        {"llm_logical_or_nd_x86", "SELECT llm_logical_or_nd(llm_vec(4, 0.0), llm_vec(4, 1.0))"},
        {"llm_bitwise_not_nd_x86", "SELECT llm_bitwise_not_nd(llm_vec(4, 0.0))"},
        {"llm_bitwise_and_nd_x86", "SELECT llm_bitwise_and_nd(llm_vec(4, 1.0), llm_vec(4, 1.0))"},
        {"llm_bitwise_or_nd_x86", "SELECT llm_bitwise_or_nd(llm_vec(4, 0.0), llm_vec(4, 1.0))"},
        {"llm_bitwise_and_scalar_nd_x86", "SELECT llm_bitwise_and_scalar_nd(llm_vec(4, 3.0), 1)"},
        {"llm_pow_scalar_nd_x86", "SELECT llm_pow_scalar_nd(2.0, llm_vec(4, 3.0))"},
        {"llm_floor_div_nd_x86", "SELECT llm_floor_div_nd(llm_vec(4, 5.0), llm_vec(4, 2.0))"},
        {"llm_remainder_nd_x86", "SELECT llm_remainder_nd(llm_vec(4, 5.0), 2.0)"},
        {"llm_remainder_tensor_nd_x86", "SELECT llm_remainder_tensor_nd(llm_vec(4, 5.0), llm_vec(4, 2.0))"},
        {"llm_reduce_sum_nd_x86", "SELECT llm_reduce_sum_nd(llm_vec(4, 2.0))"},
        {"llm_reduce_mean_nd_x86", "SELECT llm_reduce_mean_nd(llm_vec(4, 2.0))"},
        {"llm_reduce_max_nd_x86", "SELECT llm_reduce_max_nd(llm_vec(4, 2.0))"},
        {"llm_reduce_min_nd_x86", "SELECT llm_reduce_min_nd(llm_vec(4, 2.0))"},
        {"llm_reduce_argmax_nd_x86", "SELECT llm_reduce_argmax_nd(llm_vec(4, 2.0))"},
        {"llm_item_nd_x86", "SELECT llm_item_nd(llm_vec(4, 2.0), 2)"},
        {"llm_max_dim_nd_x86", "SELECT llm_max_dim_nd(llm_view_nd(llm_vec(6, 1.0), 2, 3), 1, 0)"},
        {"llm_argmax_dim_nd_x86", "SELECT llm_argmax_dim_nd(llm_view_nd(llm_vec(6, 1.0), 2, 3), 1, 0)"},
        {"llm_layernorm_nd_x86", "SELECT llm_layernorm_nd(llm_view_nd(llm_vec(4, 1.0), 1, 4), llm_vec(4, 1.0), llm_vec(4, 0.0), 1e-5)"},
        {"llm_cumsum_nd_x86", "SELECT llm_cumsum_nd(llm_view_nd(llm_vec(6, 1.0), 2, 3), 1)"},
        {"llm_cumprod_nd_x86", "SELECT llm_cumprod_nd(llm_view_nd(llm_vec(6, 1.0), 2, 3), 1)"},
        {"llm_gather_nd_x86", "SELECT llm_gather_nd(llm_view_nd(llm_vec(6, 1.0), 2, 3), 1, llm_view_nd(llm_vec(6, 0.0), 2, 3))"},
        {"llm_index_select_nd_x86", "SELECT llm_index_select_nd(llm_view_nd(llm_vec(6, 1.0), 2, 3), 0, llm_view_nd(llm_vec(2, 1.0), 2))"},
        {"llm_scatter_nd_x86", "SELECT llm_scatter_nd(llm_view_nd(llm_vec(6, 1.0), 2, 3), 1, llm_view_nd(llm_vec(6, 0.0), 2, 3), 7.0)"},
        {"llm_repeat_nd_x86", "SELECT llm_repeat_nd(llm_view_nd(llm_vec(6, 1.0), 2, 3), 2, 1)"},
        {"llm_repeat_kv_nd_x86", "SELECT llm_repeat_kv_nd(llm_view_nd(llm_vec(8, 1.0), 1, 1, 2, 4), 2)"},
        {"llm_flip_nd_x86", "SELECT llm_flip_nd(llm_view_nd(llm_vec(6, 1.0), 2, 3), 1)"},
        {"llm_roll_nd_x86", "SELECT llm_roll_nd(llm_view_nd(llm_vec(6, 1.0), 2, 3), 1, 1)"},
        {"llm_repeat_interleave_nd_x86", "SELECT llm_repeat_interleave_nd(llm_view_nd(llm_vec(6, 1.0), 2, 3), 2, 1)"},
        {"llm_norm_nd_x86", "SELECT llm_norm_nd(llm_view_nd(llm_vec(6, 1.0), 2, 3), 2.0, 1, 0)"},
        {"llm_index_put_nd_x86", "SELECT llm_index_put_nd(llm_view_nd(llm_vec(6, 1.0), 2, 3), llm_view_nd(llm_vec(6, 2.0), 2, 3), 0, NULL)"},
        {"llm_repeat_interleave_tensor_nd_x86", "SELECT llm_repeat_interleave_tensor_nd(llm_view_nd(llm_vec(6, 1.0), 2, 3), llm_view_nd(llm_vec(3, 2.0), 3), 1)"},
        {"llm_squeeze_all_nd_x86", "SELECT llm_squeeze_all_nd(llm_view_nd(llm_vec(4, 1.0), 1, 1, 4))"},
        {"llm_flatten_nd_x86", "SELECT llm_flatten_nd(llm_view_nd(llm_vec(8, 1.0), 2, 2, 2), 1, 2)"},
        {"llm_cat_multi_nd_x86", "SELECT llm_cat_multi_nd(1, llm_view_nd(llm_vec(4, 1.0), 2, 2), llm_view_nd(llm_vec(4, 2.0), 2, 2), llm_view_nd(llm_vec(4, 3.0), 2, 2))"},
        {"llm_stack_nd_x86", "SELECT llm_stack_nd(0, llm_view_nd(llm_vec(4, 1.0), 2, 2), llm_view_nd(llm_vec(4, 2.0), 2, 2))"},
        {"llm_bool_to_additive_mask_nd_x86", "SELECT llm_bool_to_additive_mask_nd(llm_view_nd(llm_vec(4, 1.0), 2, 2), 10000.0)"},
        {"llm_numel_nd_x86", "SELECT llm_numel_nd(llm_view_nd(llm_vec(8, 1.0), 2, 2, 2))"},
        {"llm_sdpa_nd_x86", "SELECT llm_sdpa_nd(llm_view_nd(llm_vec(4, 1.0), 1, 1, 2, 2), llm_view_nd(llm_vec(4, 1.0), 1, 1, 2, 2), llm_view_nd(llm_vec(4, 1.0), 1, 1, 2, 2), 1.0, 0)"},
        {"llm_quantize_int8_nd_x86", "SELECT llm_quantize_int8_nd(llm_view_nd(llm_vec(12, 1.0), 3, 4))"},
        {"llm_dequantize_int8_nd_x86", "SELECT llm_dequantize_int8_nd(llm_quantize_int8_nd(llm_view_nd(llm_vec(12, 1.0), 3, 4)))"},
        {"llm_linear_int8_nd_x86", "SELECT llm_linear_int8_nd(llm_view_nd(llm_vec(4, 1.0), 1, 4), llm_quantize_int8_nd(llm_view_nd(llm_vec(8, 1.0), 2, 4)))"},
        {"llm_linear_int8_bias_nd_x86", "SELECT llm_linear_int8_bias_nd(llm_view_nd(llm_vec(4, 1.0), 1, 4), llm_quantize_int8_nd(llm_view_nd(llm_vec(8, 1.0), 2, 4)), llm_vec(2, 0.1))"},
        {"llm_embedding_int8_nd_x86", "SELECT llm_embedding_int8_nd(llm_quantize_int8_nd(llm_view_nd(llm_vec(12, 1.0), 3, 4)), llm_view_nd(llm_vec(2, 1.0), 2))"},
        {"llm_is_int8_nd_x86", "SELECT llm_is_int8_nd(llm_quantize_int8_nd(llm_view_nd(llm_vec(12, 1.0), 3, 4)))"},
    };
...
static void benchmark_nd_and_int8_smoke_x86(sqlite3 *db) {
    static const char *bench_sqls[][2] = {
        {"bench_llm_view_nd_x86", "SELECT llm_view_nd(llm_vec(1024, 1.0), 256, 4)"},
        {"bench_llm_add_nd_x86", "SELECT llm_add_nd(llm_vec(1024, 1.0), llm_vec(1024, 2.0))"},
        {"bench_llm_softmax_nd_x86", "SELECT llm_softmax_nd(llm_view_nd(llm_vec(1024, 1.0), 32, 32), 1)"},
        {"bench_llm_bmm_x86", "SELECT llm_bmm(llm_view_nd(llm_vec(4096, 1.0), 4, 16, 64), llm_view_nd(llm_vec(4096, 1.0), 4, 64, 16))"},
        {"bench_llm_sdpa_nd_x86", "SELECT llm_sdpa_nd(llm_view_nd(llm_vec(512, 1.0), 1, 2, 16, 16), llm_view_nd(llm_vec(512, 1.0), 1, 2, 16, 16), llm_view_nd(llm_vec(512, 1.0), 1, 2, 16, 16), 0.25, 0)"},
        {"bench_llm_quantize_int8_nd_x86", "SELECT llm_quantize_int8_nd(llm_view_nd(llm_vec(4096, 1.0), 64, 64))"},
        {"bench_llm_linear_int8_nd_x86", "SELECT llm_linear_int8_nd(llm_view_nd(llm_vec(256, 1.0), 1, 256), llm_quantize_int8_nd(llm_view_nd(llm_vec(16384, 1.0), 64, 256)))"},
    };
...
int main(void) {
    ...
    TestCase tests[] = {
        ...
        {"test_unary_activation_reduction_x86", test_unary_activation_reduction_x86},
    ...
    BenchmarkCase benches[] = {
        {"bench_llm_add_simd_x86", "SELECT llm_add_simd(?, ?)", 500, 2, bench_args},
        {"bench_llm_dot_simd_x86", "SELECT llm_dot_simd(?, ?)", 1000, 2, bench_args},
        {"bench_llm_mul_simd_x86", "SELECT llm_mul_simd(?, ?)", 500, 2, bench_args},
        {"bench_llm_div_simd_x86", "SELECT llm_div_simd(?, ?)", 500, 2, bench_args},
    };
